...
class McqCubit extends Cubit<McqState> {
  ...
  Future<void> getQuestions(String categoryId) async {
    ...
    final Either<Failure, List<QuestionModel>> result = await repository.getQuestions(categoryId);
    ...
    result.fold(
      ...
      (questions) {
        ...
        // Retrieve categories if needed; here it is empty for demonstration
        final List<McqCategory> categories = []; // Modify this as needed
